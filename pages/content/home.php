...
<main id="inicio">
    ...
    <!-- FIN de Slide Hidroservicios -->

    <!-- NUESTRA HISTORIA Hidroservicios -->
    <section class="section-padding section-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                    <img src="images/news/2.jpg" class="custom-text-box-image img-fluid" alt="">
                </div>
    ...
    <!-- FIN DE NUESTRA HISTORIA Hidroservicios -->

    <!--   A QUE NOS DEDICAMOS Hidroservicios -->
    <section class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                    <div class="custom-block-wrap">
                        <img src="images/productos/11.jpg" class="custom-block-image img-fluid" alt="">
                        <div class="custom-block">
                            <div class="custom-block-body text-center">
    ...
    <!--   FIN DE A QUE NOS DEDICAMOS Hidroservicios -->

    <!-- MISION Hidroservicios -->
    <section class="about-section section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-5 col-12">
                    <img src="images/objective.png" class="about-image ms-lg-auto bg-light shadow-lg img-fluid" alt="">
                </div>
    ...
    <!-- FIN MISION Hidroservicios -->

    <!--  VISION Hidroservicios -->
    <section class="about-section section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-5 col-12">
                    <div class="custom-text-block text-center">
                        ...
                        <p class="text-muted mb-lg-4 mb-md-4"> </p>
                        <p>Ser una empresa líder en la comercialización y diversificación de
                            productos y servicios relacionados con el agua que cubran las demandas y necesidades
                            del cliente a nivel departamental.</p>
                    </div>
                </div>
                <div class="col-lg-5 col-md-7 col-12">
                    <img src="images/edificio.png" class="about-image ms-lg-auto bg-light shadow-lg img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
    <!--  FIN VISION Hidroservicios -->

    <!--  TITULO VALORES DE NUESTRA EMPRESA Hidroservicios -->
    ...
    <!--  FIN TITULO VALORES DE NUESTRA EMPRESA Hidroservicios -->

    <!--  INICIO DESCRIPCION DE VALORES -->
    <section class="section-padding">
        <div class="container">
            <div class="row">
                <!--  VALOR 1 -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-12 mx-auto">
                    <h2 class="mb-lg-3">Queridos Clientes</h2>
